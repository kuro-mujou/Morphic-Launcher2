...
private fun LuminanceMap.brightnessFor(windowSize: IntSize): BackdropBrightness = BackdropBrightness(
    map = this,
    screenToMap = screenToBitmapMapping(columns, rows, windowSize.width, windowSize.height),
)
