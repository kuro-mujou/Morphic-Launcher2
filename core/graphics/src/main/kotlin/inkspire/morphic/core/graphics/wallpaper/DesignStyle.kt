 ...
 * @property taper the design's own word for how far its elements depart in size from [scale] (*Taper*,
 *   *Size variation*, *End area*), driven by [DesignParams.taper] — null where a design's elements are all one size.
 *   A label, for [irregularity]'s reason.
