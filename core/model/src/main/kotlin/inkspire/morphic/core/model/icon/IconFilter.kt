...
/**
 * A named colour look applied to a layer, referenced by a stable [id].
 *
 ...
 * filter is one 4×5 colour matrix: bounded, self-contained, and doing the same thing to every icon. Choosing
