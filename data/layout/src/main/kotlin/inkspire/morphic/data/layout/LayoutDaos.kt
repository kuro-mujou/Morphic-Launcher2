 ...
 * of a fourteen-parameter constructor. Grouped: the six coordinate `*_placement` tables, then the folder /
 * icon-container / widget-container / app-widget / widget definition tables. Provided as one Koin singleton.
 */
class LayoutDaos(
    val appPlacement: AppPlacementDao,
    val folderPlacement: FolderPlacementDao,
    val appWidgetPlacement: AppWidgetPlacementDao,
