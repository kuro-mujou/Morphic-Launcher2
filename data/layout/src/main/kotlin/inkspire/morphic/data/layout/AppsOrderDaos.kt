 ...
 *
 * It holds the **folder** DAOs as well as the pager's, which is the whole point of the bundle: a merge on the
 * pager writes a folder, its membership and the pager slot together, and a repository that could only reach the
 * pager table would have to hand half of that back to its caller.
 */
class AppsOrderDaos(
