...
/**
 * Convention plugin `launcher.android.room`: wires Room into a module. Applies KSP, points Room's generated
 * schema at `<module>/schemas` (via reflective `ksp.arg` calls, so no direct dependency on the Room Gradle
 * plugin), and adds the Room runtime/ktx plus the KSP compiler. Used by `core:database`.
 */
