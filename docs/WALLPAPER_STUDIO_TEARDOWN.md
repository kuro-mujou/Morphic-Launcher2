...
**Twenty of twenty-two driven.** Ours-only designs have no reference to drive and are not in the count:
...
| Flow Lines | **FlowLines** | ☐ Built in W8a from the note and **not driven** — the last of theirs with something of ours standing in for it. Its knobs (*Iterations · Complexity · Thickness · Delta rotation · Start · End*) name a construction ours does not have: two of them are a **run**, which an evenly-seeded comb has no notion of. Next. |
