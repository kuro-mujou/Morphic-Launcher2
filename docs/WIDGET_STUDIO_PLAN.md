...
**Status:** design locked (2026-09-07); **WS0–WS3 done** (2026-09-18): the rename, the language, the recipe model, the renderer. The third studio, after the icon studio (done) and the
