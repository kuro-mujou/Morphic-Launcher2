...
**Status:** design locked (2026-09-07); **WS0–WS5 done, WS6a built and awaiting device check** (2026-09-18): the engine, widgets placeable on HOME, and the Style tab. **WS6b — the template library — is next**, and is a design pass rather than engineering. The third studio, after the icon studio (done) and the
