...
twelve-design template library, shown live in the picker. **WS7 (blocks, direct manipulation, the block library) and WS8
(the layer stack, Stack, pictures) are done;** WS9 (the formula editor) is next. The third studio, after the icon studio (done) and the
