...
twelve-design template library, shown live in the picker. **WS7 (blocks, direct manipulation, the block library) is done;**
WS8 (the layer stack, behind Advanced) is next. The third studio, after the icon studio (done) and the
