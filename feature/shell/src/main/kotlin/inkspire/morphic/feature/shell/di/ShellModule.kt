...
import inkspire.morphic.feature.shell.SetupMenuViewModel
 ...
 * the rest from `data:layout` and `data:apps` — the top-action band's two targets plus the item menu's app verbs,
...
val shellModule = module {
    ...
    viewModel { SetupMenuViewModel(get()) }
}
