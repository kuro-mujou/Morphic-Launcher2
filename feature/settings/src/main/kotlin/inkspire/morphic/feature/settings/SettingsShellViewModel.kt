 ...
 */
internal class SettingsShellViewModel(settingsRepository: SettingsRepository) : ViewModel() {
    ...
    // independently: a hub with a real read of its own is a section, not a corner of the shell. The setup hub has a
    // holder of its own (`SetupHubViewModel`), since what it reads is shared with HOME's menu rather than the shell's.
